...
# And place it
load = Image.open("e:\Most used\G&D\Discord1\Bridge heaven pic.jfif")
...
tyGodL = tk.Label(root, text="Thank you God -TyGod Quiz", font=("Quizzical Pitch", 30), bg="white", fg="blue")
...
Q1_Label.place(x=190, y=125)    

# First four options buttons

Q1_opt1 = Radiobutton(root, text="Mosah", variable=stringvar, value="False",  command=lambda: [GetDecision(), DiableButton()])
Q1_opt2 = Radiobutton(root, text="YHVH", variable=stringvar, value="False2",  command=lambda: [GetDecision(), DiableButton()])
Q1_opt3 = Radiobutton(root, text="YHWH", variable=stringvar, value="False3",  command=lambda: [GetDecision(), DiableButton()])
Q1_opt4 = Radiobutton(root, text="Jehova", variable=stringvar, value="True", command=lambda: [GetDecision(), DiableButton()])
...
Q2_opt1.place(x=180, y=345)
Q2_opt2.place(x=258, y=345)
Q2_opt3.place(x=336, y=345)
Q2_opt4.place(x=413, y=345)
...
Q3_opt1.place(x=182, y=560)
Q3_opt2.place(x=292, y=560)
Q3_opt3.place(x=370, y=560)
Q3_opt4.place(x=489, y=560)
...
Q4_opt2 = Radiobutton(root, text="Yes, my mom", variable=stringvar, value="False11", command=lambda: GetDecision4())
Q4_opt3 = Radiobutton(root, text="Moses", variable=stringvar, value="False12", command=lambda: GetDecision4())
Q4_opt4 = Radiobutton(root, text="Abraham", variable=stringvar, value="False13", command=lambda: GetDecision4())

# 4th options placement
Q4_opt1.place(x=850, y=190)
Q4_opt2.place(x=999, y=190)
Q4_opt3.place(x=1083, y=190)
Q4_opt4.place(x=1160, y=190)
...
Q5_opt1.place(x=850, y=350)
Q5_opt2.place(x=920, y=350)
Q5_opt3.place(x=1038, y=350)
Q5_opt4.place(x=1132, y=350)
...
Q6_opt1.place(x=850, y=560)
Q6_opt2.place(x=928, y=560)
Q6_opt3.place(x=1005, y=560)
Q6_opt4.place(x=1160, y=560)
